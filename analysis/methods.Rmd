...
This was split up into segments of a uniform length where each consecutive segment overlapped the previous segment by 70% of its length. `r fig_nums("three_segments_overlapping", display = "cite")` shows 3 overlapping segments and `r fig_nums("three_segments_separately", display = "cite")`.
